...
function WizardMagicDefense_Level1(Dexterity, Energy)
...
function WizardMagicDefense_Level2(Dexterity, Energy)
	local SkillEffect = Dexterity / 50 + Energy / 200 + 10
	local SkillTime = Energy / 40 + 60
...
function WizardMagicDefense_Level3(Dexterity, Energy)
	local SkillEffect = Dexterity / 50 + Energy / 200 + 10
	local SkillTime = Energy / 40 + 60
...
function ElfHeal(Energy)
	local SkillEffect = Energy / 5 + 5
...
function ElfDefense_Level1(Energy)
	local SkillEffect = 2 + Energy / 8
	local SkillTime = 60
...
function ElfDefense_Level2(Energy)
	local SkillEffect = 2 + Energy / 8
	local SkillTime = 60
...
function ElfAttack_Level1(Energy)
...
function ElfAttack_Level2(Energy)
	local SkillEffect = 3 + Energy / 7
	local SkillTime = 60
